...
class APIManager: SessionManager {
    ...
    static let consumerKey = "K56ejtOl7IaTEZDEu5VWghCFL"
    static let consumerSecret = "sWjorfVOcS4o6jc3lfTDTRe1JUN6AMLaP3USmehUXJoDAe3rhg"
    ...
    func compose(with text: String, completion: @escaping (Tweet?, Error?) -> ()) {
